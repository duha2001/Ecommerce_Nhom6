...
$title = "SELECT * FROM tbl_danhmuctructhuoc where id_danhmuc = '$id'";
$tbl_danhmuctructhuoc = mysqli_query($conn, $title);
$title = mysqli_fetch_assoc($tbl_danhmuctructhuoc);

$id_tructhuocsanpham = $id;
if ($id_tructhuocsanpham >= 1 && $id_tructhuocsanpham <= 5) {
?>
...
<div class="container margin-top-10">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="shadow-sm margin-bottom-10">
                <h1 class="col-title"><?= $title['title']; ?></h1>
            </div>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="shadow-sm margin-bottom-10 evo-list-accessories">
                <?php
                    $sql = "SELECT * FROM tbl_danhmuctructhuoc limit 0,5";
                    $query = mysqli_query($conn, $sql);
                    while ($row = mysqli_fetch_array($query)) {
                    ?>
                <div class="col8 col-border">
                    <a class="search-item" href="index.php?quanly=danhmuctructhuoc&id=<?php echo $row['id_danhmuc'] ?>"
                        title="<?php echo $row['title'] ?>">
                        <div class="keyword-img">

                            <img src="./dist/images/<?php echo $row['img'] ?>.png"
                                data-src="./dist/images/<?php echo $row['img'] ?>.png" alt="<?php echo $row['title'] ?>"
    ...
    <section class="products-view products-view-grid row shadow-sm">
        <?php
            $sql_tablet = "SELECT * FROM tbl_sanpham WHERE id_tructhuoc = $id ORDER BY  id_sanpham DESC";
...
<?php
} elseif ($id_tructhuocsanpham >= 6 && $id_tructhuocsanpham <= 10) {
?>
<section class="bread-crumb">
    <div class="container">
        <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
...
<div class="container margin-top-10">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="shadow-sm margin-bottom-10 evo-list-accessories">
                <?php
                    $sql = "SELECT * FROM tbl_danhmuctructhuoc limit 5,5";
                    $query = mysqli_query($conn, $sql);
                    while ($row = mysqli_fetch_array($query)) {
                    ?>
                <div class="col8 col-border">
...
<div class="container margin-top-10">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="shadow-sm margin-bottom-10 evo-list-accessories">
                <?php
                    $sql = "SELECT * FROM tbl_danhmuctructhuoc limit 10,2";
                    $query = mysqli_query($conn, $sql);
                    while ($row = mysqli_fetch_array($query)) {
                    ?>
                <div class="col8 col-border">
