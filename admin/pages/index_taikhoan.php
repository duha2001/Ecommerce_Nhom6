...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
  ...
  // show data
  $showData = "SELECT * FROM tbl_dangky WHERE id_dangky <> 1";
                ...
                ?>
                    ...
                    ?>
                                    <tr>
                                        ...
                                        <td><?php echo $arrS['sdt']; ?></td>
                                        <th><span class='label label-warning'>Khách hàng</span>
                                        <td><?php echo $arrS['code']; ?></td>
                                        <th><span class='label label-success'><?php echo $arrS['status']; ?></span>
                                        </th>
                                    </tr>
                                    <?php
                      $count++;
