...
<div class="container margin-top-10">
    ...
    <section class="products-view products-view-grid row shadow-sm">
        ...
        $sql_hienthidanhmucsp = "SELECT * FROM tbl_sanpham WHERE id_loaisanpham = $id";
        $query_hienthidanhmucsp = mysqli_query($conn, $sql_hienthidanhmucsp);


        if (mysqli_num_rows($query_hienthidanhmucsp) > 0) {
            while ($row = mysqli_fetch_array($query_hienthidanhmucsp)) {
