    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="../../index.php" target="_blank" class="logo">
                ...
                <span class="logo-mini"><b>TM</b>ĐT</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>ADMIN</b> TMĐT</span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="label label-warning"><?= $tong_cxn; ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header">Bạn có <?= $tong_cxn; ?> thông báo</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                        <?php if ($tong_cxn > 0) {
                     ...
                     <a href="quan-ly-don-hang.php?p=ql&a=donhang">
                         <i class="fa fa-shopping-cart text-green"></i> Có ' . $tong_cxn . '  đơn
                                        hàng mới
                                        chờ bạn xác
                                        nhận
                                        </a>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="../uploads/images/<?php echo $row_acc['hinh_anh']; ?>" class="user-image"
                                    alt="User Image">
                                <span class="hidden-xs"><?php echo $row_acc['ho']; ?>
                                    <?php echo $row_acc['ten']; ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="../uploads/images/<?php echo $row_acc['hinh_anh']; ?>" class="img-circle"
                                        alt="User Image">
