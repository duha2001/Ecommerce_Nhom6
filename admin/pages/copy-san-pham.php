...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
    ...
    if (isset($_POST['copy'])) {
        ...
        if (!$error) {
            ...
            // add image to folder
            $success['success'] = 'Copy thông tin sản phẩm được chọn thành công.';
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Copy thông tin sản phẩm được chọn
        </h1>
        <ol class="breadcrumb">
            <li><a href="index.php?p=index&a=statistic"><i class="fa fa-dashboard"></i> Tổng quan</a></li>
            <li><a href="ds-san-pham.php?p=sanpham&a=dssp">Quản lý sản phẩm</a></li>
            <li class="active">Copy thông tin sản phẩm được chọn</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Copy thông tin sản phẩm được chọn</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
            ...
            <div class="box-footer">
                <?php
                    if ($_SESSION['level'] == 0 || $_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-primary' name='copy'><i class='fa fa-plus'></i> Copy thông tin sản phẩm</button>";
                    ?>
            </div>
            </form>
        </div>
